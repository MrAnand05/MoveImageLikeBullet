...
class HomeState extends State<Home> with SingleTickerProviderStateMixin{
  ...
  @override
    void initState() {
      ...
      //moveAnimation=Tween<Offset>(begin: const Offset(0.0, -1.0),end: Offset.zero).animate(_controller);
      super.initState();
    }
  void callController(){
    animation=Tween(begin: 0.0,end: 20.0).animate(_controller);
    scaleAnimation=Tween(begin: 0.0,end: 1.0).animate(_controller);
    moveAnimation=Tween<Offset>(begin: const Offset(0.0, 1.0),end: Offset(0.0,0.0)).animate(_controller);
    ...
    return Scaffold(
      body: Column(
        ...
        children: <Widget>[
          ...
          child:SlideTransition(position: moveAnimation,
          child:RotationYTransition(
            turns: animation,
          child:Image.asset('assets/FlutterLogo2.jpg',),
          ),
          ),
          ),
        ],
